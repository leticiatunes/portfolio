...
toggleThemeButton.addEventListener('click', () => {
    ...
    if (rootStyles.getPropertyValue('--background-color') === '#D1C1E0') {
        ...
        rootStyles.setProperty('--progress-bg-color','#ffffff')
    } else {
        rootStyles.setProperty('--background-color', '#D1C1E0');
        rootStyles.setProperty('--text-color', '#FFDD99');
        rootStyles.setProperty('--nav-bg-color', '#5E3A73');
        rootStyles.setProperty('--nav-text-color', '#FFDD99');
        rootStyles.setProperty('--progress-bg-color','#FFDD99')
